...
% `t` top-aligns frame content. Without it beamer centres each frame vertically,
% which leaves short slides floating in the middle with a dead band under the
% title. Frames that genuinely want centring pass [c], as the figure and closing
% frames below do.
...
\begin{frame}[c]{Figure placeholder}
  \begin{center}
